...
import { buscarUsuario, atualizarUsuario } from "./actions";
...
export default function MinhaContaPage() {
  ...
  const handleSaveEdit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (resultado.success) {
        ...
        showNotification(
          "error",
          resultado.message || "Não foi possível atualizar seus dados."
        );
      }
    } catch (error) {
  ...
  const handleSavePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!resultado.error) {
        ...
        setPasswordError(resultado.error.message || "Erro ao atualizar senha");
      }
    } catch (error: unknown) {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Erro desconhecido ao atualizar senha";
  ...
  const togglePasswordVisibility = (
    field: "senhaAtual" | "novaSenha" | "confirmarSenha"
  ) => {
                  ...
                  <CardContent className="pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-medium">
                          {userData?.tel_usu || "Não informado"}
                        </p>
